# Draft-Pack for Node Applications

This is a sample draft-pack for Node applications. It contains
...
- Dockerfile: A sample Dockerfile to build image from Node projects.
